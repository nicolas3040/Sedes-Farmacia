...
const Usuarios = () => {
  ...
  const createUsuario = async () => {
    try {
      await axios.post('http://localhost:8081/usuario', { user, password, gmail });
  ...
  const updateUsuario = async () => {
    try {
      await axios.put(`http://localhost:8081/usuario/${selectedUserId}`, { user, password, gmail });
  ...
  const deleteUsuario = async (id) => {
    try {
      await axios.delete(`http://localhost:8081/usuario/${id}`);
